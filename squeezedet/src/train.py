...
tf.app.flags.DEFINE_string('train_dir', 'logs/squeezedet',
...
def train():
  ...
  with tf.Graph().as_default():
    ...
    print ("IMDB:")
    print (imdb.__dict__.keys())
    print ("imdb.__dict__.keys: _class_to_idx = {}".format(imdb.__dict__ ['_class_to_idx']))
    print ("imdb.__dict__.keys: _image_path = {}".format(imdb.__dict__ ['_image_path']))
    print ("imdb.__dict__.keys: _image_set = {}".format(imdb.__dict__ ['_image_set']))
    print ("imdb.__dict__.keys: mc = {}".format(imdb.__dict__ ['mc']))
    #print ("imdb.__dict__.keys: _image_idx = {}".format(imdb.__dict__ ['_image_idx']))
    #print ("imdb.__dict__.keys: _cur_idx = {}".format(imdb.__dict__ ['_cur_idx']))
    #print ("imdb.__dict__.keys: _eval_tool = {}".format(imdb.__dict__ ['_eval_tool']))
    #print ("imdb.__dict__.keys: _classes = {}".format(imdb.__dict__ ['_classes']))
    #print ("imdb.__dict__.keys: _perm_idx = {}".format(imdb.__dict__ ['_perm_idx']))
    #print ("imdb.__dict__.keys: _rois = {}".format(imdb.__dict__ ['_rois']))
    print ("imdb.__dict__.keys: _data_root_path = {}".format(imdb.__dict__ ['_data_root_path']))
    print ("imdb.__dict__.keys: _label_path = {}".format(imdb.__dict__ ['_label_path']))
