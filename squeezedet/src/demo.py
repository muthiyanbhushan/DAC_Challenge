...
tf.app.flags.DEFINE_string(
    'checkpoint', './data/model_checkpoints/squeezeDet/model.ckpt-99999.data-00000-of-00001',
    """Path to the model parameter file.""")
tf.app.flags.DEFINE_string(
    'input_path', './data/boat7_0521.jpg',
    """Input image or video to be detected. Can process glob input such as """
    """./data/00000*.png.""")
tf.app.flags.DEFINE_string(
    'out_dir', './logs/squeezedet/', """Directory to dump output image or video.""")
tf.app.flags.DEFINE_string(
...
def video_demo():
  ...
  with tf.Graph().as_default():
    ...
    with tf.Session(config=tf.ConfigProto(allow_soft_placement=True)) as sess:
      ...
      #tf.train.latest_checkpoint('./data/model_checkpoints/squeezeDet/model.ckpt-99999.data-00000-of-00001')
...
def image_demo():
  ...
  with tf.Graph().as_default():
    ...
    with tf.Session(config=tf.ConfigProto(allow_soft_placement=True)) as sess:
      saver = tf.train.import_meta_graph('./logs/squeezedet/model.ckpt-802500.meta')
      #saver.restore(sess, FLAGS.checkpoint)
      saver.restore(sess,tf.train.latest_checkpoint('./logs/squeezedet/'))
