...
class imdb(object):
  ...
  def read_batch(self, shuffle=True):
    ...
    Returns:
      ...
      delta_per_batch: 	 box deltas. Shape: batch_size x object_num x 
          [dx ,dy, dw, dh]
    ...
    for idx in batch_idx:
      ...
      print "/home/bhushan/squeezeDet/src/dataset/imdb.py: IDX = {0}\tself._rois: {1}".format(idx, self._rois[idx][:])
